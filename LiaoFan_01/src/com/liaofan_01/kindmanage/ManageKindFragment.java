...
//            final JSONArray jsonArray = new JSONArray( NetWorkThread.postRequest(url));
//            // ��JSONArray�����װ��Adapter
//            kindList.setAdapter(new KindArrayAdapter(jsonArray, getActivity()));
            
			String str="";
            NetWorkThread ntThread = new NetWorkThread(str);
			ntThread.setUrl(Config.getInstance().getUrl() + "job/queryAllJobs.php");
    ...
    public void onAttach(Activity activity)
    {
        ...
        {
            throw new IllegalStateException("ManageKindFragment���ڵ�Activity����ʵ��Callbacks�ӿ�!");
        }
